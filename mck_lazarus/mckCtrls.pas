...
begin
  ...
  DrawText(Canvas.Handle,PKOLChar(Caption),Length(Caption),R,Flag);
...
begin
  ...
  begin
    ...
    begin
      drawtab(r,false);
      drawtext(canvas.handle,pKOLchar(s),length(s),r,DT_CENTER or DT_VCENTER or DT_SINGLELINE);
    end;
    pages[i].fonsetbounds:=attempttochangepagebounds;
  ...
  begin
    ...
    drawtext(canvas.handle,pKOLchar(s),length(s),curr,DT_CENTER or DT_VCENTER or DT_SINGLELINE);
  end;
  ...
  begin
    ...
    begin
      I := MessageBox( Application.Handle, 'Some buttons have pictures assigned.'#13#10 +
        ...
        PKOLChar( Application.Title + ' : ' + Name ), MB_OKCANCEL );
  ...
  begin
    ...
    begin
      I := MessageBox( Application.Handle, 'Image list(s) will be detached from the toolbar.'#13#10 +
        'Continue?', PKOLChar( Application.Title + ' : ' + Name ), MB_OKCANCEL );
      if I <> ID_OK then Exit;
  ...
  begin
    ...
    begin
      I := MessageBox( Application.Handle, 'Image list(s) will be detached from ' +
        'the toolbar. Continue?', PKOLChar( Application.Title + ' : ' + Name ),
        MB_OKCANCEL );
      if I <> ID_OK then Exit;
      FToolbar.ImageListNormal := nil;
      FToolbar.ImageListDisabled := nil;
